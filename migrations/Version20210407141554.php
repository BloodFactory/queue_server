 ...
 */
final class Version20210407141554 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_AA11D4594073B09 ON organization_service_appointment (organization_service_id)');
        $this->addSql('ALTER TABLE organization_service_appointment ADD CONSTRAINT FK_AA11D4594073B09 FOREIGN KEY (organization_service_id) REFERENCES organization_service (id)');
    }
